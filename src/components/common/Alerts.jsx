    ...
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1">
        ...
        {onDismiss && (
          <button
            onClick={onDismiss}
            className="text-sm font-medium text-green-600 hover:text-green-700 mt-3"
          >
            Dismiss
          </button>
        )}
    ...
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1">
        ...
        {onDismiss && (
          <button
            onClick={onDismiss}
            className="text-sm font-medium text-yellow-600 hover:text-yellow-700 mt-3"
          >
            Dismiss
          </button>
        )}
...
const InfoAlert = ({ message, onDismiss }) => (
